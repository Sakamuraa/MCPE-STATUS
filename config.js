...
module.exports = {
  ...
  mcserver: {
    ip: "bibd.os-srv.me", // IP of  MC server.
    port: 25627, // Port number of MC server. Default Port - Java: 25565, Bedrock: 19132.
    type: "bedrock", // Type of MC server: "java" or "bedrock".
    name: "Badan Intelijen Bokep Dunia", // Name of MC server.
    version: "1.20.51", // Version of MC server.
  ...
  autoReply: {
    ...
    status: {
      ...
      onlineReply:
        "The server is **`🟢ONLINE`** with **`{playerOnline}/{playerMax}`** players playing.",
